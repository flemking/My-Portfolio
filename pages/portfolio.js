...
function Portfolio() {
  ...
  const portfolio = [
    {
      key: 24,
      title: "Export Benin — National Exporters Directory",
    ...
    {
      key: 23,
      title: "Offyn — Operations & Automation",
      imageUrl: shot("https://webxify.com/projects/offyn"),
      techs: [
        "Landing Page",
        "Admin Dashboard",
        "GoHighLevel",
      ...
      url: "https://webxify.com/projects/offyn",
    },
    {
      key: 22,
      title: "Virtual Same Day Marriage — CRM & Automation",
      imageUrl: shot("https://virtualsamedaymarriage.com"),
      techs: [
        "Zoho CRM",
        "Automated Booking",
        "SMS Automation",
      ...
      url: "https://virtualsamedaymarriage.com",
    },
    {
      key: 21,
      title: "Flow Pilates Studio",
      imageUrl: shot("https://flowpilates.bj"),
      techs: [
        "Branding",
        "Online Booking",
        "Payments",
      ...
      url: "https://flowpilates.bj",
    },
    {
      key: 20,
      title: "Mon Entreprise — Business Formalization Portal",
      imageUrl: shot("https://monentreprise.bj"),
      techs: ["Landing Page", "Guided Form", "Public Service", "Onboarding"],
      url: "https://monentreprise.bj",
    },
    {
      key: 19,
      title: "Lagni Consulting",
      imageUrl: shot("https://lagniconsulting.ca"),
      techs: ["WordPress", "Recruitment", "Multilingual", "Blog"],
      url: "https://lagniconsulting.ca",
    },
    {
      key: 18,
      title: "Assurances BTP",
      imageUrl: shot("https://assurancesbtp.com"),
      techs: ["Showcase Site", "Portfolio", "Partner Visibility"],
      url: "https://assurancesbtp.com",
    },
    {
      key: 17,
      title: "Solution88",
      imageUrl: shot("https://solution88.netlify.app"),
      techs: ["Netlify", "Showcase Site", "In Progress"],
      url: "https://solution88.netlify.app",
    },
    {
      key: 16,
      title: "Les Fruits Tillou",
      imageUrl: shot("https://les-fruits-tillou.netlify.app"),
      techs: ["Netlify", "Food Brand", "Landing Page", "In Progress"],
      url: "https://les-fruits-tillou.netlify.app",
    },
    {
      key: 12,
